...
public class FloatLabelEditText
    ...
    private int mCurrentApiVersion = Build.VERSION.SDK_INT, mFocusedColor, mUnFocusedColor, mFitScreenWidth, mGravity;
    ...
    private void getAttributesFromXmlAndStoreLocally() {
        ...
        mGravity = attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_gravity, Gravity.START);
        ...
        mIsNumeric = (attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_inputType, 0) == 2);
    ...
    private void setupEditTextView() {
        ...
        if (mIsNumeric) {
            mEditTextView.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL | InputType.TYPE_NUMBER_FLAG_SIGNED);
            mEditTextView.setTypeface(Typeface.DEFAULT);
        }
        ...
        if (mCurrentApiVersion >= Build.VERSION_CODES.HONEYCOMB) {
    ...
    private void setupFloatingLabel() {
        ...
        mFloatingLabel.setTextSize(TypedValue.COMPLEX_UNIT_SP, (float)(mTextSizeInSp / 1.5));
